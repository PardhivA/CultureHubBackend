...
export default function Userpost(params) {
  ...
  const [scaleOfButtonSelectedImage, setScaleOfButtonSelectedImage] =
    useState("1.5");
      ...
      const makeApiCall = async () => {
        try {
          const res = await axios.post(
            "https://culture1.onrender.com/api/post/",
            addpost
          );
      ...
      <div className="addcontainer">
        <div className="addcontainerMain">
          <div className="buttonsOnAddPostDiv">
            <button
              className="button"
              style={{ scale: scaleOfButtonSelectedImage }}
            >
              Post Image
            </button>
          ...
          <div
            style={{
              ...
              borderRadius: borderRadiusOfForm,
              padding: "0 1rem",
            }}
          >
